package ru.store.repository;

import ru.store.StoreApp;
import ru.store.config.Constants;
import ru.store.config.audit.AuditEventConverter;
import ru.store.domain.PersistentAuditEvent;
...
import static ru.store.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
