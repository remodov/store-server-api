...
import ru.store.StoreApp;
import ru.store.domain.Authority;
import ru.store.domain.User;
import ru.store.repository.AuthorityRepository;
...
import ru.store.web.rest.errors.ExceptionTranslator;
import ru.store.web.rest.vm.KeyAndPasswordVM;
import ru.store.web.rest.vm.ManagedUserVM;
